...
<div class="mb-3">
    <a href="AgregarHoteles.php" class="btn btn-success">Agregar Nuevo Plan</a>
</div>
<br>
<br>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="ActualizarHoteles.php?id=<?= $hotel['ID_Hotel']; ?>" class="btn btn-success btn-sm">Comprar</a></center>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
