...
<?php require_once "LAYOUT/header.php"; ?>
    ...
    <div class="container">
        <a href="AgregarVuelos.php" class="btn"><b>Agregar Vuelo</b></a>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <?php foreach ($vuelos as $vuelo): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <a href="ActualizarVuelos.php?id=<?php echo $vuelo['ID_Vuelo']; ?>">Actualizar</a>
                            <a href="EliminarVuelos.php?id=<?php echo $vuelo['ID_Vuelo']; ?>" class="delete" onclick="return confirm('¿Estás seguro de eliminar este vuelo?');">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
